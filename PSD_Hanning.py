...
M=2.45574e+06 - 2.45243e+06
print M
DaTA=[]
for L in range(DatA1.shape[0]):
    Tn=DatA1[L,0]
    Fn=DatA1[L,1]*(m.cos(m.pi*((Tn-(2.45408e+06)))/M)**2)
#    e1=Data1[l,2]
#    e2=Data1[l,3]
    DaTA.append([Tn,Fn])
Data1=np.array(DaTA)
names="350GHz_hanning.dat"
np.savetxt(route1+names, Data1)
